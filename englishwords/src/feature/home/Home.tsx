  ...
  return(
    <div className=" mt-20 flex flex-col px-5">
      ...
      <div className="flex flex-col gap-2 mt-20">
        <FeatureInfo title="모의 시험을 통해 실력을 확인해보세요" content="시험과 유사한 방식의 문제를 풀어보면서 문제점을 확인하고 시험에 익숙해져보세요" image="test"/>
        <FeatureInfo title="단어의 뜻과 발음을 외워보세요" content="시험에서 자주 나오는 단어를 발음과 함께 외워보세요" image="word"/>
        <FeatureInfo title="단계별에 맞는 템플릿을 확인해보세요" content="단계별 자주 사용되는 문장을 템플릿으로 만나보세요" image="template"/>
      </div>
      <div>
